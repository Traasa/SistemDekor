...
export default function CreateRolePage({ permissions }: Props) {
        ...
        <AdminLayout>
            <div className="mx-auto max-w-4xl space-y-6">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600">Define a new role with specific permissions</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
                        ...
                        <input
                            ...
                            placeholder="e.g., manager, staff, sales"
                        ...
                        <p className="mt-2 text-xs text-gray-500">Use lowercase with underscores (e.g., sales_manager)</p>
                    </div>
                    ...
                    <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
                        <div className="mb-4">
                            ...
                            <p className="text-sm text-gray-600">Select permissions for this role ({data.permissions.length} selected)</p>
                        </div>
