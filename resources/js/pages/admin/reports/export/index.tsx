                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <ul className="text-sm text-blue-800 space-y-1">
                                <li>â€¢ Data akan di-export dalam format CSV yang dapat dibuka dengan Excel atau Google Sheets</li>
                                <li>â€¢ Pastikan range tanggal sudah sesuai sebelum melakukan export</li>
                                <li>â€¢ File akan otomatis ter-download setelah proses export selesai</li>
                                <li>â€¢ Untuk laporan inventaris, data mencakup seluruh periode (tidak terbatas tanggal)</li>
                            </ul>
                        </div>
                    </div>
                </div>
