...
interface OperationalCost {
    id: number;
    cost_code: string;
    cost_type: 'production' | 'catering_raw_material' | 'other';
    title: string;
            ...
            <div className="p-6">
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">Catat biaya produksi, bahan baku catering, dan biaya lain-lain.</p>
                    </div>
                            ...
                            <tbody className="divide-y divide-gray-200 bg-white">
                                {rows.map((row) => (
                                    <tr key={row.id}>
                                        ...
                                        <td className="px-4 py-3 text-sm text-gray-700">{formatTypeLabel(row.cost_type)}</td>
                        ...
                        <div className="w-full max-w-2xl rounded-lg bg-white p-6">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label className="mb-1 block text-sm font-medium text-gray-700">Reference Type (opsional)</label>
                                        <input type="text" value={formData.reference_type} onChange={(e) => setFormData((prev) => ({ ...prev, reference_type: e.target.value }))} className="w-full rounded-lg border px-3 py-2" />
                                    </div>
                                </div>

                                <div>
                                    <label className="mb-1 block text-sm font-medium text-gray-700">Reference ID (opsional)</label>
                                    <input type="number" min="0" value={formData.reference_id} onChange={(e) => setFormData((prev) => ({ ...prev, reference_id: e.target.value }))} className="w-full rounded-lg border px-3 py-2" />
                                </div>
