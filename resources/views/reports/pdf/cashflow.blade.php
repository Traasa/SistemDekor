    ...
    <div class="content">
        <div class="summary-box">
            ...
            <div class="summary-row">
                ...
                <span class="amount positive">Rp {{ number_format($data['income'], 0, ',', '.') }}</span>
            </div>
            
            <div class="summary-row">
                <span class="label">Pengeluaran Inventaris</span>
                <span class="amount">Rp {{ number_format($data['expenses']['inventory'], 0, ',', '.') }}</span>
            </div>
            
            <div class="summary-row">
                <span class="label">Pengeluaran Lainnya</span>
                <span class="amount">Rp {{ number_format($data['expenses']['other'], 0, ',', '.') }}</span>
            </div>
            
            <div class="summary-row">
                <span class="label">Total Pengeluaran</span>
                <span class="amount negative">Rp {{ number_format($data['expenses']['total'], 0, ',', '.') }}</span>
            </div>
            
            <div class="summary-row">
                <span class="label">Keuntungan Bersih</span>
                <span class="amount {{ $data['net_profit'] >= 0 ? 'positive' : 'negative' }}">
            ...
            <div class="summary-row">
                ...
                <span class="amount">{{ number_format($data['profit_margin'], 2) }}%</span>
            </div>
        </div>
    </div>
