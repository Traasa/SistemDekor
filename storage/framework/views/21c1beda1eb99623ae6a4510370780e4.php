        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    ...
                    <td class="text-right">Rp <?php echo e(number_format($defaultDp, 0, ',', '.')); ?></td>
                    <td class="text-center">-</td>
                    <td class="text-center"><span class="badge">BELUM</span></td>
                </tr>
                <tr>
                    <td>2. Cicilan 1 (Sesi 2) 40%</td>
                    <td class="text-right">Rp <?php echo e(number_format($defaultInstallment, 0, ',', '.')); ?></td>
                    <td class="text-center">-</td>
                    <td class="text-center"><span class="badge">BELUM</span></td>
                </tr>
                <tr>
                    <td>3. Pelunasan (Sesi 3) 30%</td>
                    <td class="text-right">Rp <?php echo e(number_format($defaultFull, 0, ',', '.')); ?></td>
                    <td class="text-center">-</td>
                    <td class="text-center"><span class="badge">BELUM</span></td>
                </tr>
            <?php endif; ?>
