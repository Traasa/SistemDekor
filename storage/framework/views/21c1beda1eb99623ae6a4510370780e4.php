...
<head>
    ...
    <style>
        ...
        /* Header Meta Table */
        .meta-table { width: auto; margin-left: auto; margin-right: 0; }
...
<body>
    ...
    <table style="width: 100%;">
        <tr>
            <td style="width: 50%; vertical-align: top;">
                <div style="font-size: 24px; font-weight: bold; color: #1e3a5f;">ADE DECORATION</div>
            </td>
    ...
    <table class="info-section">
        <tr>
            ...
            <td style="width: 4%;"></td>
            <td style="width: 48%;">
                <div class="info-title">Info Acara</div>
                <div class="info-line"></div>
                <div class="info-content">
